'''This module only contains the RadarData class, which is used to save
general Radar data properties.
...
class RadarData(object):
    ...
    def lon_site(self):
        ...
        Longitude coordinate of radar location. Must be set as 
    ...
    def lat_site(self):
        ...
        Latitude coordinate of radar location. Must be set as 
        numpy.float64 or numpy.ndarray.
    ...
    def ele(self):
        ...
        Elevation of radar beam in degrees. Must be numpy.ndarray or 
        numpy.float64.
    ...
    def azi_rays(self):
        ...
        Number of azimuth rays of the radar, which usually is 360. Must 
        be a numpy.int64 or int.
    ...
    def r_bins(self):
        ...
        Number of range bins of the radar. Must be a numpy.int64 or int.
    ...
    def r_start(self):
        ...
        Starting value of range. Must be numpy.float32 or numpy.float64.
    ...
    def azi_steps(self):
        ...
        Steps between two measurements in azimuth angle. Must be float.
    ...
    def r_steps(self):
        ...
        Steps in range between two measurements. Must be numpy.float32
        or numpy.float64.
